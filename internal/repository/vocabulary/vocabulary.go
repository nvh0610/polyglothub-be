...
func (u *Implement) List(limit, offset int, categoryId int, word string, categoryIds []int, typeVocab string) ([]*Vocabularies, int, error) {
	...
	if typeVocab != "" {
		query = query.Where("type = ?", typeVocab)
	}
