...
func ToListVocabularyResponse(vocabularies []*vocabulary.Vocabularies) ListVocabularyResponse {
	var response ListVocabularyResponse
	for _, item := range vocabularies {
		response.Vocabularies = append(response.Vocabularies, ToVocabularyResponse(item))
	}
